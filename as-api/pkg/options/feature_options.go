...
import (
	...
	"github.com/shipengqi/asapi/pkg/server"
)
...
func (o *FeatureOptions) Validate() []error { return nil }
...
func (o *FeatureOptions) AddFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&o.EnableMetrics, "feature.metrics", o.EnableMetrics,
		"Enables metrics on the apiserver at /debug/metrics")
}
