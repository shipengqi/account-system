...
import { isChinese, isColor, isDecimal, isIdCard, isInt, isIp, isMobile, isNum, isUrl } from '../format';
...
export class _Validators {
  ...
  /**
   * Wheter is IPv4/IPv6 address (Support v4, v6)
   *
   * 是否 IPv4/IPv6 地址（支持v4、v6）
   */
